...
typedef enum _M_ASIAuthenticationState {
	M_ASINoAuthenticationNeededYet = 0,
	M_ASIHTTPAuthenticationNeeded = 1,
	M_ASIProxyAuthenticationNeeded = 2
} M_ASIAuthenticationState;

typedef enum _M_ASINetworkErrorType {
    M_ASIConnectionFailureErrorType = 1,
    M_ASIRequestTimedOutErrorType = 2,
    M_ASIAuthenticationErrorType = 3,
    M_ASIRequestCancelledErrorType = 4,
    M_ASIUnableToCreateRequestErrorType = 5,
    M_ASIInternalErrorWhileBuildingRequestType  = 6,
    M_ASIInternalErrorWhileApplyingCredentialsType  = 7,
	M_ASIFileManagementError = 8,
	M_ASITooMuchRedirectionErrorType = 9,
	M_ASIUnhandledExceptionError = 10,
	M_ASICompressionError = 11
	
} M_ASINetworkErrorType;
...
@interface M_ASIHTTPRequest : NSOperation <NSCopying> {
	...
	id <M_ASIHTTPRequestDelegate> delegate;
	...
	id <M_ASIHTTPRequestDelegate, M_ASIProgressDelegate> queue;
	...
	// If error code is = M_ASIConnectionFailureErrorType (1, Connection failure occurred) - inspect [[error userInfo] objectForKey:NSUnderlyingErrorKey] for more information
	NSError *error;
	...
	id <M_ASIProgressDelegate> uploadProgressDelegate;
	...
	id <M_ASIProgressDelegate> downloadProgressDelegate;
	...
	M_ASIAuthenticationState authenticationNeeded;
	...
	M_ASIDataDecompressor *dataDecompressor;
	...
	M_ASIHTTPRequest *PACFileRequest;
...
@property (atomic, assign) M_ASIHTTPRequest *mainRequest;
...
@property (atomic, assign, readonly) M_ASIAuthenticationState authenticationNeeded;
...
@property (atomic, assign) id <M_ASICacheDelegate> downloadCache;
@property (atomic, assign) M_ASICachePolicy cachePolicy;
@property (atomic, assign) M_ASICacheStoragePolicy cacheStoragePolicy;
...
#endif
@property (atomic, retain) M_ASIDataDecompressor *dataDecompressor;
